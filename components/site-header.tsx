...
export default function SiteHeader({ dict }: { dict: any }) {
  ...
  return (
    <header className="w-full bg-white py-3 sm:py-5 sticky top-0 z-50 border-b border-gray-200 shadow-sm">
        ...
        <div className="lg:hidden absolute top-full left-0 w-full bg-white border-b border-gray-200 shadow-lg z-40">
          <nav className="container mx-auto py-4 px-4">
            <ul className="space-y-4">
              ...
              <li className="px-4 py-2 border-t border-gray-200 mt-4 pt-4">
